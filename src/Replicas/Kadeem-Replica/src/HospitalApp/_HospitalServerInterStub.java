...
/**
* HospitalApp/_HospitalServerInterStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from hospitalserver.idl
* Sunday, October 27, 2019 11:26:52 AM EDT
*/

public class _HospitalServerInterStub extends org.omg.CORBA.portable.ObjectImpl implements HospitalApp.HospitalServerInter
{
  ...
  public boolean checkAppointment (String appointmentType, String appointmentID, String patientID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("checkAppointment", true);
                $out.write_string (appointmentType);
                $out.write_string (appointmentID);
                $out.write_string (patientID);
                $in = _invoke ($out);
                ...
                return checkAppointment (appointmentType, appointmentID, patientID        );
            } finally {
                _releaseReply ($in);
            }
  } // checkAppointment
...
} // class _HospitalServerInterStub
